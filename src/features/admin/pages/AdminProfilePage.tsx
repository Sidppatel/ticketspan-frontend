        ...
        <CardContent className="space-y-3">
          {user?.googleConnected ? (
            <div className="flex items-center justify-between gap-3">
              <p className="text-sm text-success">Google account connected</p>
            ...
            <div className="space-y-2">
              <p className="text-sm text-muted-foreground">Connect your Google account for one-click sign-in.</p>
