...
/**
 * @generated from protobuf service entryvine.booking.TableBookingService
 */
export interface ITableBookingServiceClient {
    /**
     * @generated from protobuf rpc: GetEventLayout(entryvine.common.UuidValue) returns (entryvine.booking.EventLayout);
     */
    getEventLayout(input: UuidValue, options?: RpcOptions): UnaryCall<UuidValue, EventLayout>;
    /**
     * @generated from protobuf rpc: SaveEventLayout(entryvine.booking.SaveEventLayoutRequest) returns (entryvine.common.AckResponse);
     */
    saveEventLayout(input: SaveEventLayoutRequest, options?: RpcOptions): UnaryCall<SaveEventLayoutRequest, AckResponse>;
    /**
     * @generated from protobuf rpc: LockTable(entryvine.booking.LockTableRequest) returns (entryvine.common.AckResponse);
     */
    lockTable(input: LockTableRequest, options?: RpcOptions): UnaryCall<LockTableRequest, AckResponse>;
    /**
     * @generated from protobuf rpc: ReleaseTableLock(entryvine.booking.LockTableRequest) returns (entryvine.common.AckResponse);
     */
    releaseTableLock(input: LockTableRequest, options?: RpcOptions): UnaryCall<LockTableRequest, AckResponse>;
    /**
     * @generated from protobuf rpc: ListTablesForEvent(entryvine.common.UuidValue) returns (entryvine.booking.ListTablesResponse);
     */
    listTablesForEvent(input: UuidValue, options?: RpcOptions): UnaryCall<UuidValue, ListTablesResponse>;
    /**
     * @generated from protobuf rpc: ListEventTableTypes(entryvine.common.UuidValue) returns (entryvine.booking.ListEventTableTypesResponse);
     */
    listEventTableTypes(input: UuidValue, options?: RpcOptions): UnaryCall<UuidValue, ListEventTableTypesResponse>;
    /**
     * @generated from protobuf rpc: CreateEventTable(entryvine.booking.CreateEventTableRequest) returns (entryvine.common.UuidValue);
     */
    createEventTable(input: CreateEventTableRequest, options?: RpcOptions): UnaryCall<CreateEventTableRequest, UuidValue>;
    /**
     * @generated from protobuf rpc: DeleteEventTable(entryvine.common.UuidValue) returns (entryvine.common.AckResponse);
     */
    deleteEventTable(input: UuidValue, options?: RpcOptions): UnaryCall<UuidValue, AckResponse>;
    /**
     * @generated from protobuf rpc: CreateEventTicketType(entryvine.booking.CreateEventTicketTypeRequest) returns (entryvine.common.UuidValue);
     */
    ...
    /**
     * @generated from protobuf rpc: UpdateEventTicketType(entryvine.booking.UpdateEventTicketTypeRequest) returns (entryvine.common.AckResponse);
     */
    ...
    /**
     * @generated from protobuf rpc: DeleteEventTicketType(entryvine.common.UuidValue) returns (entryvine.common.AckResponse);
     */
     ...
     * from that template.
     *
     * @generated from protobuf rpc: CreateTableTemplatePriceRule(entryvine.booking.CreateTableTemplatePriceRuleRequest) returns (entryvine.common.UuidValue);
     */
    ...
    /**
     * @generated from protobuf rpc: ListTableTemplatePriceRules(entryvine.common.UuidValue) returns (entryvine.booking.ListTableTemplatePriceRulesResponse);
     */
    listTableTemplatePriceRules(input: UuidValue, options?: RpcOptions): UnaryCall<UuidValue, ListTableTemplatePriceRulesResponse>;
    /**
     * @generated from protobuf rpc: DeleteTableTemplatePriceRule(entryvine.common.UuidValue) returns (entryvine.common.AckResponse);
     */
     ...
     *
     * @generated from protobuf rpc: ListTableTemplates(entryvine.common.Empty) returns (entryvine.booking.ListTableTemplatesResponse);
     */
    listTableTemplates(input: Empty, options?: RpcOptions): UnaryCall<Empty, ListTableTemplatesResponse>;
    /**
     * @generated from protobuf rpc: CreateTableTemplate(entryvine.booking.CreateTableTemplateRequest) returns (entryvine.common.UuidValue);
     */
    createTableTemplate(input: CreateTableTemplateRequest, options?: RpcOptions): UnaryCall<CreateTableTemplateRequest, UuidValue>;
    /**
     * @generated from protobuf rpc: UpdateTableTemplate(entryvine.booking.UpdateTableTemplateRequest) returns (entryvine.common.AckResponse);
     */
    updateTableTemplate(input: UpdateTableTemplateRequest, options?: RpcOptions): UnaryCall<UpdateTableTemplateRequest, AckResponse>;
    /**
     * @generated from protobuf rpc: DeleteTableTemplate(entryvine.common.UuidValue) returns (entryvine.common.AckResponse);
     */
