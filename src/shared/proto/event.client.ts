...
/**
 * @generated from protobuf service entryvine.event.EventService
 */
export interface IEventServiceClient {
    /**
     * @generated from protobuf rpc: CreateEvent(entryvine.event.CreateEventRequest) returns (entryvine.event.CreateEventResponse);
     */
    createEvent(input: CreateEventRequest, options?: RpcOptions): UnaryCall<CreateEventRequest, CreateEventResponse>;
    /**
     * @generated from protobuf rpc: UpdateEvent(entryvine.event.UpdateEventRequest) returns (entryvine.common.AckResponse);
     */
    updateEvent(input: UpdateEventRequest, options?: RpcOptions): UnaryCall<UpdateEventRequest, AckResponse>;
    /**
     * @generated from protobuf rpc: DeleteEvent(entryvine.common.UuidValue) returns (entryvine.common.AckResponse);
     */
    deleteEvent(input: UuidValue, options?: RpcOptions): UnaryCall<UuidValue, AckResponse>;
    /**
     * @generated from protobuf rpc: GetEvent(entryvine.common.UuidValue) returns (entryvine.event.Event);
     */
    getEvent(input: UuidValue, options?: RpcOptions): UnaryCall<UuidValue, Event>;
    /**
     * @generated from protobuf rpc: GetEventBySlug(entryvine.event.GetEventBySlugRequest) returns (entryvine.event.Event);
     */
    getEventBySlug(input: GetEventBySlugRequest, options?: RpcOptions): UnaryCall<GetEventBySlugRequest, Event>;
    /**
     * @generated from protobuf rpc: ListEvents(entryvine.event.ListEventsRequest) returns (entryvine.event.ListEventsResponse);
     */
    listEvents(input: ListEventsRequest, options?: RpcOptions): UnaryCall<ListEventsRequest, ListEventsResponse>;
    /**
     * @generated from protobuf rpc: SearchEvents(entryvine.event.SearchEventsRequest) returns (entryvine.event.ListEventsResponse);
     */
    searchEvents(input: SearchEventsRequest, options?: RpcOptions): UnaryCall<SearchEventsRequest, ListEventsResponse>;
    /**
     * @generated from protobuf rpc: ChangeEventStatus(entryvine.event.ChangeEventStatusRequest) returns (entryvine.common.AckResponse);
     */
    changeEventStatus(input: ChangeEventStatusRequest, options?: RpcOptions): UnaryCall<ChangeEventStatusRequest, AckResponse>;
    /**
     * @generated from protobuf rpc: GetEventStats(entryvine.common.UuidValue) returns (entryvine.event.EventStats);
     */
    getEventStats(input: UuidValue, options?: RpcOptions): UnaryCall<UuidValue, EventStats>;
    /**
     * @generated from protobuf rpc: SetEventFeesIncluded(entryvine.event.SetEventFeesIncludedRequest) returns (entryvine.common.AckResponse);
     */
     ...
     *
     * @generated from protobuf rpc: SetEventAch(entryvine.event.SetEventAchRequest) returns (entryvine.common.AckResponse);
     */
    setEventAch(input: SetEventAchRequest, options?: RpcOptions): UnaryCall<SetEventAchRequest, AckResponse>;
    /**
     * @generated from protobuf rpc: ListScheduleItems(entryvine.common.UuidValue) returns (entryvine.event.ListScheduleItemsResponse);
     */
    listScheduleItems(input: UuidValue, options?: RpcOptions): UnaryCall<UuidValue, ListScheduleItemsResponse>;
    /**
     * @generated from protobuf rpc: CreateScheduleItem(entryvine.event.CreateScheduleItemRequest) returns (entryvine.common.UuidValue);
     */
    createScheduleItem(input: CreateScheduleItemRequest, options?: RpcOptions): UnaryCall<CreateScheduleItemRequest, UuidValue>;
    /**
     * @generated from protobuf rpc: UpdateScheduleItem(entryvine.event.UpdateScheduleItemRequest) returns (entryvine.common.AckResponse);
     */
    updateScheduleItem(input: UpdateScheduleItemRequest, options?: RpcOptions): UnaryCall<UpdateScheduleItemRequest, AckResponse>;
    /**
     * @generated from protobuf rpc: DeleteScheduleItem(entryvine.common.UuidValue) returns (entryvine.common.AckResponse);
     */
    deleteScheduleItem(input: UuidValue, options?: RpcOptions): UnaryCall<UuidValue, AckResponse>;
    /**
     * @generated from protobuf rpc: ListEventImages(entryvine.event.ListEventImagesRequest) returns (entryvine.event.ListEventImagesResponse);
     */
    listEventImages(input: ListEventImagesRequest, options?: RpcOptions): UnaryCall<ListEventImagesRequest, ListEventImagesResponse>;
    /**
     * @generated from protobuf rpc: AddEventImage(entryvine.event.AddEventImageRequest) returns (entryvine.event.EventImage);
     */
    addEventImage(input: AddEventImageRequest, options?: RpcOptions): UnaryCall<AddEventImageRequest, EventImage>;
    /**
     * @generated from protobuf rpc: RemoveEventImage(entryvine.event.RemoveEventImageRequest) returns (entryvine.common.AckResponse);
     */
    removeEventImage(input: RemoveEventImageRequest, options?: RpcOptions): UnaryCall<RemoveEventImageRequest, AckResponse>;
    /**
     * @generated from protobuf rpc: SetPrimaryEventImage(entryvine.event.RemoveEventImageRequest) returns (entryvine.common.AckResponse);
     */
    setPrimaryEventImage(input: RemoveEventImageRequest, options?: RpcOptions): UnaryCall<RemoveEventImageRequest, AckResponse>;
    /**
     * @generated from protobuf rpc: ReorderEventImages(entryvine.event.ReorderEventImagesRequest) returns (entryvine.common.AckResponse);
     */
    reorderEventImages(input: ReorderEventImagesRequest, options?: RpcOptions): UnaryCall<ReorderEventImagesRequest, AckResponse>;
    /**
     * @generated from protobuf rpc: GetMediaSettings(entryvine.common.Empty) returns (entryvine.event.MediaSettings);
     */
